...
public interface SpotsApi {
     ...
     *
     * @param apiSpot Optional description in *Markdown* (required)
    ...
    default ResponseEntity<Void> addPrivateSpot(
        @Parameter(name = "ApiSpot", description = "Optional description in *Markdown*", required = true) @Valid @RequestBody ApiSpot apiSpot
    ) {
